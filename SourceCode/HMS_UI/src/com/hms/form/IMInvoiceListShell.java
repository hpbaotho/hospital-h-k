...
public class IMInvoiceListShell extends Shell {
	...
	public IMInvoiceListShell(Display display) {
		...
		btnAdd.setBounds(315, 606, 103, 30);
		btnAdd.setText("Add");
		...
		btnEdit.setBounds(440, 606, 103, 30);
		...
		btnExit.setBounds(692, 606, 103, 30);
		...
		btnDelete.setBounds(567, 606, 103, 30);
		createContents();
	}
