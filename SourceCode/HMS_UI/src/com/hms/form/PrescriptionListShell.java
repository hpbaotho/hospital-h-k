...
public class PrescriptionListShell extends Shell {
	private Table table;
	...
	public static void main(String args[]) {
		try {
			...
			PrescriptionListShell shell = new PrescriptionListShell(display);
			shell.open();
			shell.layout();
	 ...
	 * @param display
	 */
	public PrescriptionListShell(Display display) {
		super(display, SWT.SHELL_TRIM);
		setImage(SWTResourceManager.getImage(PrescriptionListShell.class, "/com/hms/icon/hms-invoice-io-icon.png"));
		...
		tblclmnInvoiceNumber.setWidth(143);
		tblclmnInvoiceNumber.setText("Prescription Number");
		...
		tblclmnAddress.setWidth(139);
		tblclmnAddress.setText("Doctor");
		
		TableColumn tblclmnWarehouse = new TableColumn(table, SWT.CENTER);
		tblclmnWarehouse.setWidth(332);
		tblclmnWarehouse.setText("Symptom");
		
		Button btnAdd = new Button(composite, SWT.NONE);
		btnAdd.addSelectionListener(new SelectionAdapter() {
			@Override
			public void widgetSelected(SelectionEvent e) {
				PrescriptionShell prescriptionShell = new PrescriptionShell(getDisplay());
		...
		btnAdd.setImage(SWTResourceManager.getImage(PrescriptionListShell.class, "/com/hms/icon/hms-add-icon.png"));
		...
		btnEdit.setImage(SWTResourceManager.getImage(PrescriptionListShell.class, "/com/hms/icon/hms-edit-icon.png"));
		...
		btnExit.setImage(SWTResourceManager.getImage(PrescriptionListShell.class, "/com/hms/icon/hms-cancel-icon.png"));
		btnExit.setBounds(709, 590, 133, 46);
		
		Button btnDelete = new Button(composite, SWT.NONE);
		btnDelete.setFont(SWTResourceManager.getFont("Times New Roman", 12, SWT.BOLD));
		btnDelete.setText("Delete");
		btnDelete.setImage(SWTResourceManager.getImage(PrescriptionListShell.class, "/com/hms/icon/hms-delete-icon.png"));
	...
	protected void createContents() {
		setText(Messages.getString("HMS.PrescriptionListShell.title"));
		setSize(900, 700);
